...
/**
 * Glavni razred igre, vključuje metodo main (z njim poženemo program). Ustvari
 * novo okno, v katerem je igralno polje (privzeto mreža 4 x 4), in okno
 * prikaže.
 */
public class Igra2048 extends JFrame {
    ...
    private void ustvariGUI() {
        ...
        setResizable(false);
        // v okno postavimo objekt polje, in sicer v središče (uporabimo robno
        // razvrščanje)
